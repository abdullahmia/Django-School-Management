# Generated by Django 2.2.13 on 2021-01-31 08:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_assignment', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], default='yes', max_length=5)),
                ('is_quiz', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], default='yes', max_length=5)),
